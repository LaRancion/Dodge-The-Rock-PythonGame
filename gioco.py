...
while running:
    ...
    if random.randint(0, object_spawn_rate) == 0:
        objects.append([random.choice([column1_x, column2_x]), 0]) or objects.append([random.choice([column1_x, column3_x]), 0]) or objects.append([random.choice([column2_x, column3_x]), 0])
