...
player = (player_width, player_height, player_x, player_y, player_speed)
object = (object_width, object_height, object_speed, object_spawn_rate, objects)
